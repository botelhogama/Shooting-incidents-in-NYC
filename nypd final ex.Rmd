...
nyfcomp <- nyf_incidents_by_year
 ...
 Another observation is that incidents wich black people are involved are greater than any other race in New York City. That shows a social inequality in education, opportunities and cultural of people geographically close of each other, only based on wealthy and skin collour.
